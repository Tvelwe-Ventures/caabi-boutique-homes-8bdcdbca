...
const services = [
  ...
  },
  {
    ...
    className: "lg:col-span-1 hover:bg-primary/5"
  },
  {
    Icon: Palette,
    ...
    className: "lg:col-span-1 lg:row-span-1 hover:bg-primary/5"
  },
  {
    Icon: Users,
  ...
  },
  {
    ...
    className: "lg:col-span-2 hover:bg-primary/5"
  }
];
